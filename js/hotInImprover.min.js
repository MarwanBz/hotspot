...
function registerHotInputElements() {
  var a = document.querySelectorAll("input[improve-input]");
...
function onChangeInputValue(a) {
  var b = a.value;
  a.hasAttribute("rm-white-spaces") && (b = b.split(" ").join(""));
  a.hasAttribute("to-lower") && (b = b.toLowerCase());
  a.hasAttribute("to-upper") && (b = b.toUpperCase());
  a.hasAttribute("to-arabic-numbers") && (b = toArabicNumbers(b));
  a.hasAttribute("only-numbers") && (b = b.replace(/\D/g, ""));
  a.hasAttribute("no-numbers") && (b = b.replace(/[0-9]/g, ""));
  a.hasAttribute("only-alphanumeric") && (b = b.replace(/[^0-9a-z]/gi, ""));
  a.hasAttribute("to-tel-type-when") && toTelTypeWhen(a, b);
  a.value = b;
}
function toArabicNumbers(a) {
  return a
    .replace(RegExp(":", "g"), "0")
...
function toTelTypeWhen(a, b) {
  var c = a.getAttribute("to-tel-type-when");
  null != c &&
    "" !== c &&
    (b.length < parseInt(c)
